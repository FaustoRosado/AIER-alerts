...
│   └── API_REFERENCE.md
│
├── PROJECT_CONTEXT.md          # Context for Claude Code Desktop
├── CLAUDE_CODE_PROMPTS.md      # All prompts for Claude Code Desktop
└── README.md                   # This file
```
...
This repository includes comprehensive prompts for Claude Code Desktop in CLAUDE_CODE_PROMPTS.md. These prompts guide Claude through:

1. Loading project context
2. Rebuilding the GitHub repository with proper commit history
3. Auditing and fixing security issues
4. Building demonstration components
5. Verifying infrastructure
6. Finalizing documentation

Start by having Claude read PROJECT_CONTEXT.md, then proceed through the prompts in order.
